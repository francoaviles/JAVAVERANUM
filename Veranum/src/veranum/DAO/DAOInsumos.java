...
public class DAOInsumos {
    ...
    public static boolean sqlUpdate(ClInsumos insumo){
        String sql="UPDATE \"insumos\" SET \"nombre\" = '"+insumo.getNombre()+"' AND \"descripcion\" = '"+insumo.getDescripcion()+"'  WHERE \"id_insumo\" = '"+insumo.getIdInsumo()+"'";
        bd.sqlEjecutar(sql);   
        return true;
    }
    
    public ClInsumos sqlLeer(int id){     
